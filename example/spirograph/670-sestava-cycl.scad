...
translate([0,-19,135])rotate([0,0,180])rameno(xpos=-5,ypos=47.5,zpos=1,xrot=0,zrot=-6,ax=-69,az=-2,fix=true,fxcolor="green");

prevody(poz=true,pap=3,angle=55,color="green");
