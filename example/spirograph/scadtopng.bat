...
set OPENSCADPATH="M:\Dokumenty\OpenSCAD\library
...
"c:\program files\openscad\openscad.exe" -o "%~n1.png" --imgsize 3000,1500 --projection p --enable all --colorscheme White --summary all --csglimit 200000 "%1"
